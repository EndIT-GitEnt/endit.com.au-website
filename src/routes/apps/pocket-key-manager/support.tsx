...
export const Route = createFileRoute("/apps/pocket-key-manager/support")({
  head: () => ({
    meta: [
      { title: "Support — Pocket Key Manager — End iT" },
      {
        name: "description",
        content:
      ...
      {
        property: "og:title",
        content: "Support — Pocket Key Manager — End iT",
      },
      {
      ...
      {
        property: "og:url",
        content: "https://endit.com.au/apps/pocket-key-manager/support",
      },
    ],
    links: [
      {
        rel: "canonical",
        href: "https://endit.com.au/apps/pocket-key-manager/support",
      },
    ],
  }),
  component: PKMSupportPage,
});

function PKMSupportPage() {
  return (
        ...
        <div className="space-y-12">
          ...
          <section>
            ...
            <ol className="ml-4 list-decimal space-y-3 text-sm leading-relaxed text-[#f5f5f5]/70">
              <li>
                <span className="font-semibold text-[#f5f5f5]">App name</span> — Pocket Key Manager
              </li>
              <li>
              ...
              <li>
                <span className="font-semibold text-[#f5f5f5]">Screenshots</span> — only if they
            ...
            <div className="space-y-3 text-sm leading-relaxed text-[#f5f5f5]/70">
              <p>
                ...
                <strong className="text-[#f5f5f5]">
                  do not send backup files or sensitive operational data
                </strong>{" "}
                from the app in your support email unless you are authorised to do so and have
                assessed the sensitivity of the information.
              </p>
              <p>
          ...
          {/* Data recovery */}
          <section>
            <h2 className="mb-4 text-xl font-bold text-[#f5f5f5]">Data Recovery</h2>
            <div className="space-y-3 text-sm leading-relaxed text-[#f5f5f5]/70">
              <p>
              ...
              <p>
                We strongly recommend creating regular backups using the app and storing those
                backup files in a secure location separate from your device.
              </p>
            </div>
          </section>
